"""vapersway_20965 URL Configuration
...
admin.site.site_header = "VapersWay"
admin.site.site_title = "VapersWay Admin Portal"
admin.site.index_title = "VapersWay Admin"

# swagger
api_info = openapi.Info(
    title="VapersWay API",
    default_version="v1",
    description="API documentation for VapersWay App",
)
